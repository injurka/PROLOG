...
<div id="readme-top"/>
  <h1>Содержание</h1>
  <ul>
    <li><a href="#1-представление-правил-в-продукционном-программировании">Представление правил в продукционном программировании</a></li>
    <li><a href="#2-семантические-и-ассоциативные-сети">Семантические и ассоциативные сети</a></li>
    <li><a href="#3-фреймовая-модель-представления-знаний">Фреймовая модель представления знаний</a></li>
    <li><a href="#4-обучение-сети-по-методу-обратного-распространения-ошибки">Обучение сети по методу обратного распространения ошибки</a></li>
    <li><a href="#5-понятие-и-особенности-интеллектуальных-информационных-систем">Понятие, и особенности интеллектуальных информационных систем</a></li>
    <li><a href="#6-системы-основанные-на-знаниях">Системы, основанные на знаниях</a></li>
    <li><a href="#7-модели-представления-знаний">Модели представления знаний</a></li>
    <li><a href="#8-продукционная-модель-правила-продукций">Продукционная модель (правила продукций)</a></li>
    <li><a href="#9-представление-и-обработка-непределенности-в-продукционных-системах">Представление и обработка непределенности в продукционных системах</a></li>
    <li><a href="#10-байесова-модель">Байесова модель</a></li>
    <li><a href="#11-сетевые-модели-и-графы">Сетевые модели и графы</a></li>
    <li><a href="#12-рейтинговая-модель">Рейтинговая модель</a></li>
    <li><a href="#13-нечеткая-модель">Нечеткая модель</a></li>
    <li><a href="#14-фреймы-и-объективно-ориентирована-представление-знаний">Фреймы и объективно-ориентирована представление знаний</a></li>
    <li><a href="#15-cитуационный-подход-в-представлении-знаний-и-выводе-решений"> Ситуационный подход в представлении знаний и выводе решений</a></li>
    <li><a href="#16-системы-интеллектуального-анализа-данных-извлечение-знаний-из-данных">Системы интеллектуального анализа данных. Извлечение знаний из данных</a></li>
    <li><a href="#17-архитектура-многослойных-нейронных-сетей">Архитектура многослойных нейронных сетей</a></li>
    <li><a href="#18-активация-нейронной-сети-посредством-прямого-распространения">Активация нейронной сети посредством прямого распространения</a></li>
    <li><a href="#19-распараллеливание-процесса-обучения-нейронных-сетей-с-помощью-tensorflow">Распараллеливание процесса обучения нейронных сетей с помощью TensorFlow</a></li>
    <li><a href="#20-классификация-изображений-с-помощью-глубоких-сверточных-нейронных-сетей">Классификация изображений с помощью глубоких сверточных нейронных сетей</a> <b>NOPE</b></li>
    <li><a href="#21-строительные-блоки-сверточных-нейронных-сетей">Строительные блоки сверточных нейронных сетей</a> <b>NOPE</b></li>
    <li><a href="#22-понятие-сверточных-нейронных-сетей">Понятие сверточных нейронных сетей</a></li>
    <li><a href="#23-выполнение-дискретных-сверток-в-сверточной-нейронной-сети">Выполнение дискретных сверток в сверточной нейронной сети</a> <b>NOPE</b></li>
    <li><a href="#24-работа-с-множественными-входными-или-цветовыми-каналами-в-сверточной-нейронной-сети">Работа с множественными входными или цветовыми каналами в сверточной нейронной сети</a> <b>NOPE</b></li>
    <li><a href="#25-архитектура-многослойной-сверточной-нейронной-сети">Архитектура многослойной сверточной нейронной сети</a> <b>NOPE</b></li>
  </ul>
<hr/>
<br />
...
## 14. Фреймы и объективно-ориентирована представление знаний
...
## 15. Ситуационный подход в представлении знаний и выводе решений
...
## 16. Системы интеллектуального анализа данных. Извлечение знаний из данных
...
## 17. Архитектура многослойных нейронных сетей
...
## 18. Активация нейронной сети посредством прямого распространения
...
## 19. Распараллеливание процесса обучения нейронных сетей с помощью TensorFlow
...
## 20. Классификация изображений с помощью глубоких сверточных нейронных сетей

<p align="right"><a href="#readme-top">К содержанию ^</a></p>

## 21. Строительные блоки сверточных нейронных сетей

<p align="right"><a href="#readme-top">К содержанию ^</a></p>

## 22. Понятие сверточных нейронных сетей
...
## 23. Выполнение дискретных сверток в сверточной нейронной сети

<p align="right"><a href="#readme-top">К содержанию ^</a></p>

## 24. Работа с множественными входными или цветовыми каналами в сверточной нейронной сети

<p align="right"><a href="#readme-top">К содержанию ^</a></p>

## 25. Архитектура многослойной сверточной нейронной сети
